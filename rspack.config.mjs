...
const HOST = "https://b293-14-241-249-24.ngrok-free.app";
  ...
  return {
    ...
    plugins: [
      ...
      new Repack.plugins.ModuleFederationPluginV2({
        ...
        dts: false,
        remotes: {
          // miniapp: `miniapp@http://172.16.1.6:3000/${platform}/mf-manifest.json`,
          // miniapp: `miniapp@http://172.16.1.6:3000/build/generated/${platform}/miniapp.container.js.bundle`,
          wmsApp: `wmsApp@${HOST}/build/generated/${platform}/wmsApp.container.js.bundle`,
        },
        /**
